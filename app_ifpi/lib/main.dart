            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      launch('https://github.com/Ayrton-Sena');
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.green,
                      foregroundColor: Colors.white,
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildInfoContato(
              nome: 'Ayrton Pereira Monteiro Sena',
              email: 'ayrtonoftitan@gmail.com',
              matricula: '2022111MTDS0819',
          ...
          child: Column(
            ...
            children: [
              CircleAvatar(
                radius: 70,
                backgroundImage: NetworkImage(
                  'C:\Users\Ayrton\Pictures\Camera Roll\MeControlXXLUserTile.jpg',
                ),
              ),
              const SizedBox(height: 20),
              _buildInfoPerfil(
